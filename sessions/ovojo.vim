...
silent only
cd ~/work/public_html/system/application/views/light/public
...
badd +27 v_contest.php
badd +383 v_store.php
badd +22 v_three_boxes.php
badd +42 ~/work/public_html/scripts/light/my_store_logged.js
badd +61 v_store_comments.php
...
badd +2 v_col_sx.php
badd +26 v_home.php
badd +22 v_coupons_list.php
badd +49 v_coupon.php
...
badd +102 v_header.php
badd +18 v_footer.php
badd +74 ~/work/public_html/forum/styles/nexus/template/overall_footer.html
badd +1402 ~/work/public_html/css/light/default.css
badd +35 v_stores_list.php
...
badd +9 v_big_map_controls.php
badd +91 v_help.php
badd +2 ~/work/public_html/scripts/light/my_help.js
badd +25 v_premium_en_GB.php
badd +1 v_premium_it_IT.php
badd +31 v_premium_ru_RU.php
badd +11 ~/work/public_html/system/application/hooks/h_locale.php
badd +1 ~/work/public_html/system/application/controllers/public/brands_list.php
badd +89 v_brands_list.php
...
badd +1 old_v_search_results.php
...
badd +126 ~/.vimrc
badd +40 ~/work/public_html/scripts/light/my_profile.js
...
badd +1 v_purchase_list_purchases.php
...
badd +5 v_legal_en_GB.php
badd +5 v_legal_ru_RU.php
badd +1 email/v_notify_follower.php
...
badd +17 email/v_newsletter_09042011.php
...
badd +15 email/v_newsletter_09042011_it.php
badd +2 v_banners_home.php
...
badd +1 email/v_newsletter_12052011_it.php
...
badd +1 email/v_newsletter_12052011_en.php
badd +15 email/v_newsletter_09042011_en.php
badd +72 email/v_notify_new_purchase.php
...
badd +4 v_product_list.php
badd +10 v_product_list_products.php
badd +1 v_col_sx_products_filters.php
badd +1 ~/work/public_html/scripts/light/my_product_list.js
badd +31 v_col_sx_products.php
...
badd +21 ~/work/public_html/scripts/light/my_notifications.js
badd +64 ~/work/public_html/system/application/models/m_notifications.php
badd +11 ~/work/public_html/system/application/controllers/public/notifications.php
badd +4 v_popup_notifications.php
...
badd +54 ~/work/public_html/system/application/libraries/quickauth.php
...
badd +93 ~/work/public_html/system/application/controllers/register.php
...
badd +30 ~/work/public_html/scripts/light/my_register.js
...
badd +1 v_popup_notifications_notifications.php
badd +1 v_profile_purchase_stats.php
silent! argdel *
...
exe 'vert 1resize ' . ((&columns * 22 + 102) / 204)
exe 'vert 2resize ' . ((&columns * 181 + 102) / 204)
argglobal
enew
file NERD_tree_1
setlocal fdm=manual
...
setlocal fen
silent! normal! zE
let s:l = 98 - ((19 * winheight(0) + 24) / 49)
...
argglobal
enew
file ~/work/public_html/system/application/controllers/public/NERD_tree_2
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
setlocal fen
silent! normal! zE
let s:l = 44 - ((41 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
44
...
argglobal
enew
file ~/work/public_html/system/application/models/NERD_tree_3
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
exe 'vert 1resize ' . ((&columns * 31 + 102) / 204)
exe 'vert 2resize ' . ((&columns * 172 + 102) / 204)
tabedit ~/work/public_html/system/application/views/light/public/v_profile.php
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
argglobal
enew
file ~/work/public_html/system/application/views/light/public/NERD_tree_4
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
wincmd w
argglobal
edit ~/work/public_html/system/application/views/light/public/v_profile_purchase_stats.php
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
setlocal fen
silent! normal! zE
let s:l = 87 - ((23 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
87
...
setlocal fen
silent! normal! zE
let s:l = 199 - ((7 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
199
...
bwipeout
NERDTree ~/work
1resize 49|vert 1resize 22|2resize 49|vert 2resize 181|
tabnext 2
1wincmd w
bwipeout
...
1wincmd w
bwipeout
NERDTree ~/work/public_html/system/application/models
1resize 49|vert 1resize 31|2resize 49|vert 2resize 172|
tabnext 4
1wincmd w
bwipeout
NERDTree ~/work/public_html/system/application/views
